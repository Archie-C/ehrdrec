...
from examples.model_training.rasnet import build_rasnet_model
from ehrdrec.training.losses import OriginalGAMENetLoss


def test_rasnet_training_adapter_runs_on_synthetic_batch():
    batch_size = 3
    seq_len = 4
    n_diagnoses = 20
    n_procedures = 15
    ...
    features["diagnoses"][2, :, 5] = 1
    features["procedures"][2, :, 6] = 1
